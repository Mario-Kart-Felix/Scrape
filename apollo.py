...
for d in data:
  ...
  time.sleep(1)
  numemp = driver.find_element_by_xpath('//*[@id="provider-mounter"]/div/div[2]/div[2]/div/div[1]/div[2]/div[2]/div/div[2]/div/div[1]/div/div[2]/div[2]/div/div[1]/div/div[1]/div/span/a/span[1]')
  numempint = int(numemp.get_attribute('innerText'))
