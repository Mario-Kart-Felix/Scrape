...
for d in data:
  ...
  for i in [1,2,3,4,5]:
    ...
    try:
      ...
      df.to_csv(f"/Users/danielschwartz/Desktop/SF_csv/{num_total_emp}{str_company}.csv")
      # driver.quit()
