...
for d in data:
  ...
  str_company = strcompany.replace(" ", "_")
  df = pd.DataFrame({"name" : np_name_array, "role" : np_role_array, "city" : np_home_array})
  df.to_csv(f"/Users/danielschwartz/Desktop/SF_csv/{num_total_emp}_{str_company}.csv")
  # driver.quit()
  if numempint > 125:
